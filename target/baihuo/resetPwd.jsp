...
$(document).ready(function() {
	...
	function submitLogin() {
		...
		// 1.$.ajax带json数据的异步请求
		var aj = $.ajax({
			url : '${_ctx_}/user/resetPwd',// 跳转到 action
			data : {
				username : tel,
				password : password,
				tel : tel,
			...
			success : function(data) {
				JiaFang.hideLoading();
				if (data.code == 200) {
					location.href = "${_ctx_}/page/login"
				} else {
					JiaFang.showFailedToast("重置失败！" + data.description);
             ...
             <form id="registForm">
             	 <table class="loginTable" cellpadding="0" cellspacing="0">
                      ...
                      <tr>
                          <td></td>
                          <td class="btnTd">
                              <input id="btnLogin" class="btn btnLogin" type="button" value="重置密码" onclick="submitLogin()"/>
